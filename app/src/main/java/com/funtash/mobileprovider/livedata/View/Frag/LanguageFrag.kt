...
import com.funtash.mobileprovider.databinding.LanguageFragBinding
...
class LanguageFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = LanguageFragBinding.inflate(inflater,container,false)
